...
public class AutoIDUitl {
	...
	public static String sinhMaBan() {
		Ban_DAO banDAO = RestaurantApplication.getInstance().getDatabaseContext().newEntity_DAO(Ban_DAO.class);
	...
	public static String sinhMaMon() {
		List<MonAn> listMon = RestaurantApplication.getInstance().getDatabaseContext().newEntity_DAO(MonAn_DAO.class)
	...
	public static String phatSinhMaKH() {
		KhachHang_DAO dao = RestaurantApplication.getInstance().getDatabaseContext().newEntity_DAO(KhachHang_DAO.class);
	...
	public static String sinhMaKhuyenMai() {
		...
		KhuyenMai_DAO kmDAO = RestaurantApplication.getInstance().getDatabaseContext()
	...
	public static String sinhMaHoaDon() {
		HoaDon_DAO hdDAO = RestaurantApplication.getInstance().getDatabaseContext().newEntity_DAO(HoaDon_DAO.class);
	...
	public static String sinhMaNhanVien() {
		NhanVien_DAO nvDAO = RestaurantApplication.getInstance().getDatabaseContext().newEntity_DAO(NhanVien_DAO.class);
	...
	public static String sinhMaTaiKhoan() {
		TaiKhoan_DAO tkDAO = RestaurantApplication.getInstance().getDatabaseContext().newEntity_DAO(TaiKhoan_DAO.class);
