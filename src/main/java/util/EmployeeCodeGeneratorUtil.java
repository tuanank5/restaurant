...
public class EmployeeCodeGeneratorUtil {
	private static long currentEmployeeCount = RestaurantApplication.getInstance().getDatabaseContext()
			.newEntity_DAO(NhanVien_DAO.class).count("NhanVien.count", NhanVien.class);;
