...
public class ThongTinChiTietNV_Controller implements Initializable {
	...
	private void loadComboBox() {
		...
		cmbTrangThai.setItems(javafx.collections.FXCollections.observableArrayList("Đang làm việc", "Ngưng làm việc"));
	}

	private void showCapNhat() {
		if (nhanVien != null) {
			CapNhatNhanVien_Controller controller = MenuNVQL_Controller.instance.readyUI("NhanVien/CapNhatNhanVien")
					.getController();
